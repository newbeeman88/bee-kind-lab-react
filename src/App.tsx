...
const allMockPosts: Post[] = [
  ...
  },
  {
    ...
    date: '1 week ago',
    image: 'https://images.unsplash.com/photo-1551582045-6ec9c11d8697?w=400&h=200&fit=crop',
    likes: 31,
    upvotes: 25,
    downvotes: 2,
    comments: 16
  ...
  },
  {
    ...
    author: 'SwarmCatcher',
    date: '1 month ago',
    image: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?w=400&h=200&fit=crop',
    likes: 33,
    upvotes: 27,
    downvotes: 2,
    comments: 18
